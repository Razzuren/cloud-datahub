...
@NgModule({
  ...
  providers: [
    ...
    provideConfig(<CdsConfig>{
      cds: {
        tenant: 'kakakakaka',
        baseUrl: 'https://htpissforps.us.context.cloud.sap/',
        endpoints: {
    ...
    provideConfig(<CdsConfig>{
      cds: {
        profileTag: {
          javascriptUrl:
            'https://tag.static.us.context.cloud.sap/config/htpissforps-testsite-default',
          configUrl: 'https://tag.static.us.context.cloud.sap/config/htpissforps-testsite-default',
